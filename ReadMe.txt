========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : Contacts
========================================================================


AppWizard has created this Contacts application for you.  This application
...
Contacts.h
    ...
    CContactsApp application class.
...
res\Contacts.ico
    ...
    icon is included by the main resource file Contacts.rc.
...
ContactsDlg.h, ContactsDlg.cpp - the dialog
    These files contain your CContactsDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in Contacts.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CContactsDlgAutoProxy class.  This class
